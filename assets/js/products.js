...
const CONTACTO = {
  whatsapp: '5215519540241',   // formato internacional para wa.me
  telefono: '5519540241',
...
const PRODUCTOS = [
  /* ------------------------------------------------------------------ 01 */
  {
    slug: 'silla-alta-3-en-1',
    name: 'Silla alta 3 en 1',
    model: 'BH-522',
    tagline: 'Tres formas de acompañar su crecimiento',
    age: '6 meses – 3 años aprox.',
    keywords: ['silla alta', 'periquera alta', '3 en 1', 'comer'],
    colors: [
      { id: 'gris', name: 'Gris', hex: '#B9BCBE', image: 'assets/images/products/bh-522/bh-522-silla-alta.webp' }
    ],
    ...
    sku: 'NIN-SILLAALTA-BH522-GRI',
    barcode: '7503061922104',
    weight: '3.8 kg',
    boxedWeight: '4.3 kg',
    boxDimensions: '43.5 × 24.5 × 41 cm',
    images: {
      ...
      gallery: [
        { src: 'assets/images/products/bh-522/bh-522-arnes.webp', alt: 'Detalle del arnés de 5 puntos de la silla alta Ninino BH-522', position: '50% 50%', role: 'detalle' }
      ]
    }
  },
  ...
  /* ------------------------------------------------------------------ 02 */
  {
    ...
    name: 'Periquera',
    model: 'BH-525',
    tagline: 'Lista para acompañar la hora de comer',
    age: '6 meses – 3 años aprox.',
    keywords: ['periquera', 'mesita', 'silla baja', 'comer'],
    colors: [
      { id: 'gris', name: 'Gris', hex: '#B9BCBE', image: 'assets/images/products/bh-525/bh-525-periquera.webp' }
    ],
    featuresTitle: '3 configuraciones de uso',
    features: [
    ...
    sku: 'NIN-PERIQUERA-BH525-GRI',
    barcode: '7503061922067',
    weight: '6.6 kg',
    boxedWeight: '7.4 kg',
    boxDimensions: '52 × 22 × 52 cm',
    images: {
      ...
      gallery: [
        { src: 'assets/images/products/bh-525/bh-525-arnes.webp', alt: 'Detalle del arnés de 5 puntos de la periquera Ninino BH-525', position: '50% 50%', role: 'detalle' }
      ]
    }
  },
  ...
  /* ------------------------------------------------------------------ 03 */
  {
    slug: 'silla-escalonada',
    name: 'Silla escalonada',
    model: 'BH-524',
    tagline: 'Diseñada para acompañar su niñez',
    age: '10 meses – 5 años aprox.',
    keywords: ['silla escalonada', 'tippy trapp', 'crecedera', 'madera'],
    colors: [
      { id: 'blanco', name: 'Blanco', hex: '#F2F0EC', image: 'assets/images/products/bh-524/bh-524-con-charola.webp' }
    ],
    featuresTitle: '3 configuraciones de uso',
    features: [
    ...
    sku: 'NIN-TIPPTRAPP-BH524-BLA',
    barcode: '7503061922012',
    weight: '9.8 kg',
    boxedWeight: '11.2 kg',
    boxDimensions: '85 × 43 × 13 cm',
    images: {
      ...
      gallery: [
        { src: 'assets/images/products/bh-524/bh-524-arnes.webp', alt: 'Detalle del arnés de 5 puntos de la silla escalonada Ninino BH-524', position: '50% 50%', role: 'detalle' }
      ]
    }
  },
  ...
  /* ------------------------------------------------------------------ 04 */
  {
    slug: 'banera-plegable',
    name: 'Bañera plegable',
    model: 'BH-327+212',
    modelAlt: 'BH-327',
    tagline: 'Perfecta para la hora del baño',
    age: '0 meses – 3 años aprox.',
    ...
    featuresTitle: '3 variantes de color',
    features: [],
    highlights: [
      { title: 'Plegable', text: 'Fácil de guardar.' },
      { title: 'Cojín incluido', text: 'Una ayuda para su postura.' }
    ],
    sku: 'Según variante',
    barcode: 'Según variante',
    weight: '1.4 kg',
    boxedWeight: '2.0 kg',
  ...
  {
    slug: 'escalera-wc',
    name: 'Escalera para WC',
    model: 'BH-153',
    tagline: 'Un paso más hacia su autonomía',
    age: '2+ años',
    ...
    featuresTitle: '2 variantes de color',
    features: [],
    highlights: [
      { title: 'Material resistente', text: 'Materiales duraderos.' },
      { title: 'Ajuste de altura', text: 'Se adapta a varios estilos de WC.' }
    ],
    sku: 'Según variante',
    barcode: 'Según variante',
    weight: '1.7 kg',
    boxedWeight: '2.2 kg',
    boxDimensions: '32 × 13 × 40.2 cm',
    images: {
      ...
      gallery: [
        { src: 'assets/images/products/bh-153/bh-153-estructura.webp', alt: 'Detalle del escalón de la escalera para WC Ninino BH-153', position: '50% 50%', role: 'detalle' },
        { src: 'assets/images/products/bh-153/bh-153-ajuste.webp', alt: 'Detalle del ajuste de altura de la escalera para WC Ninino BH-153', position: '50% 50%', role: 'detalle' }
      ]
    }
  },
  ...
  /* ------------------------------------------------------------------ 06 */
  {
    ...
    name: 'Scooter',
    model: 'BH-810',
    tagline: 'Movimiento que se disfruta',
    age: '2+ años',
    keywords: ['scooter', 'montable', 'correpasillos', 'ruedas'],
    colors: [
      { id: 'gris', name: 'Gris', hex: '#BFB6AC', image: 'assets/images/products/bh-810/bh-810-perfil.webp' }
    ],
    ...
    highlights: [
      { title: 'Giros 360°', text: '' },
      { title: 'Llantas PU', text: 'Para un deslizamiento suave.' }
    ],
    sku: 'NIN-SCOOTER-BH810-GRI',
    barcode: '7503061922029',
    weight: '3.2 kg',
    boxedWeight: '3.8 kg',
  ...
  /* ------------------------------------------------------------------ 07 */
  {
    ...
    name: 'Bañera térmica',
    model: 'BH-221',
    tagline: 'Baños seguros y cómodos todos los días',
    age: '0 – 24 meses aprox.',
    keywords: ['bañera térmica', 'banera termica', 'termómetro', 'tina', 'baño'],
    colors: [
      { id: 'gris', name: 'Gris', hex: '#C3C6C8', image: 'assets/images/products/bh-221/bh-221-respaldo.webp' }
    ],
    featuresTitle: 'Funciones principales',
    features: [
    ...
    highlights: [
      { title: 'Termómetro digital', text: 'Monitorea la temperatura del agua al instante.' },
      { title: 'Plegable y compacta', text: 'Fácil de guardar y transportar.' }
    ],
    sku: 'NIN-BATHTUB-BH221-GRI',
    barcode: '7503061922036',
    weight: '0.6 kg',
    boxedWeight: '1.1 kg',
    boxDimensions: '30.5 × 9 × 54.5 cm',
    images: {
      ...
      gallery: [
        { src: 'assets/images/products/bh-221/bh-221-termometro.webp', alt: 'Detalle del termómetro digital de la bañera térmica Ninino BH-221', position: '50% 50%', role: 'detalle' }
      ]
    }
  },
  ...
  /* ------------------------------------------------------------------ 08 */
  {
    slug: 'periquera-plegable',
    name: 'Periquera plegable',
    model: 'BH-515',
    tagline: 'Práctica para cada comida',
    age: '6 meses – 2 años aprox.',
    keywords: ['periquera plegable', 'booster', 'silla de comer', 'portátil'],
    colors: [
      { id: 'verde', name: 'Verde', hex: '#1F5F6B', image: 'assets/images/products/bh-515/bh-515-abierta.webp' }
    ],
    featuresTitle: 'Funciones principales',
    features: [
    ...
    highlights: [
      { title: 'Arnés de 3 puntos', text: 'Sujeción ajustable durante su uso.' },
      { title: 'Plegado compacto', text: 'Ocupa menos espacio al guardar.' }
    ],
    sku: 'NIN-SCOM-BH515-VER',
    barcode: '7503061922005',
    weight: '2.3 kg',
    boxedWeight: '3.0 kg',
